...
Аддон берёт только `Image Texture` nodes из материалов выделенных mesh-объектов. Все найденные текстуры приводятся к одной длинной стороне с сохранением пропорций: например `512x512 -> 4096x4096`, `1024x512 -> 4096x2048`, `512x1024 -> 2048x4096`. После апскейла текстуры заменяются в материалах выбранных моделей.
